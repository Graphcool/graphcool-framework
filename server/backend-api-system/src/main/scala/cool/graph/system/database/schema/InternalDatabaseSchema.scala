  ...
  lazy val setupActions = DBIO.seq(
    ...
    sqlu"""
      CREATE TABLE IF NOT EXISTS `Project` (
        ...
        `requestLimitExceeded` tinyint(1) NOT NULL DEFAULT '0',
        `invocationLimitExceeded` tinyint(1) NOT NULL DEFAULT '0',
        `databaseLimitExceeded` tinyint(1) NOT NULL DEFAULT '0',
        PRIMARY KEY (`id`),
