...
* Input and output fields can [only be of scalar types](https://github.com/graphcool/graphcool-framework/issues/256) at the moment.
* [Only one query or mutation field](https://github.com/graphcool/graphcool-framework/issues/326) can be added per resolver.
